export const HELP_CONTENT = {
    drawing: [
        ...
        },
        {
            ...
            a: [
                { type: 'text', content: 'Select the "Draw" button, then click and drag on the body to highlight the area where you feel pain or sympotms. Use the slider to change the size of the brush.' },
                { type: 'gif', src: 'assets/help/Drawing.gif', alt: 'Example of drawing on the body to indicate pain areas' }
            ]
        },
        {
            ...
            a: [
                ...
                { type: 'image', src: 'assets/help/Erase.png', alt: 'Screenshot showing the "Erase" button' }
            ]
        },
        {
            ...
            a: [
                ...
                { type: 'image', src: 'assets/help/Select Body Region.png', alt: 'Screenshot showing the "Select Body Region" button' }
            ]
        },
        {
            ...
            a: [
                ...
                { type: 'gif', src: 'assets/help/Zoom In Out.gif', alt: 'Example of zooming in and out on the body using scroll wheel'}
            ]
        },
        {
            ...
            'a': [
                ...
                { type: 'image', src: 'assets/help/Rotation Arrows.png', alt: 'Screenshot showing the "Rotate" button' }
            ]
        }
    ],
    summary: [
